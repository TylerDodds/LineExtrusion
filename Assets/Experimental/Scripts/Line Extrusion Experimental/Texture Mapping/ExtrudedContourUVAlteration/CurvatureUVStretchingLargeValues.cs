...
namespace BabyDinoHerd.Extrusion.Line.TextureMapping.Alteration.Experimental
{
    ...
    /// Uses points where line curvature begins to have large curvature and stretches u-parameters evenly (based on arcdistance) between them.
    /// </summary>
    [BabyDinoHerd.Experimental]
    public class CurvatureUVStretchingLargeValues : CurvatureUVStretchingBase
    {
        /// <summary>
        ...
        {
            return CurvatureUParameterDetermination.GetUParametersOfMiddleOfSegmentsOnBorderOfLargeCurvature(extrudedLinePoints, curvatureAngleCutoffDegrees: 3f);
        }
    }
}